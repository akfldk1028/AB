...
class FrontendCLIAgent:
    ...
    def enhance_query_with_mcp(self, query: Query) -> str:
        ...
        try:
            ...
            frontend_keywords = ["react", "vue", "angular", "next", "nuxt", "tailwind", "bootstrap", "typescript", "javascript"]
            found_library = None
            ...
            if len(query.split()) > 10 or "component" in query.lower() or "design" in query.lower():
                try:
